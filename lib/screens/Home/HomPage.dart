          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                text: const TextSpan(
                  style: TextStyle(
                      ...
                      color: Colors.black),
                  children: [
                    TextSpan(text: "Quick Fix, Trusted Electricians & Stores Near You"),
                  ],
                ),
              ),
              SizedBox(height: SizeHelper.byHeight(context, 8)),
              const Text(
                "Find Trusted Electricians & Products in One Tap",
                style: TextStyle(
              ...
              _RoundedCard(
                ...
                subtitle: "Skilled pros near you for home",
                onTap: () {onAddProduct();},
              ),
              SizedBox(height: SizeHelper.byHeight(context, 16)),
              _RoundedCard(
                title: "Shop Electric Products",
                subtitle: "Search nearby electric shops",
                onTap: () {onBookingList();},
              ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const _BenefitRow(text: "certified electricians"),
                        const _BenefitRow(text: "Buy electric items from nearby shops"),
                        const _BenefitRow(text: "Chat directly with your electrician or electric shop"),
                      ],
                    ),
                  ),
                  Positioned(
